...
@Directive({
  selector:
    "[allowText][ngModel],[allowText][formControl],[allowText][formControlName],[allowText]",
})
  ...
  validate(input) {
    ...
    switch (patternCode) {
      ...
      case "searchIdValidator":
        ...
        break;
      case "bloodBankUrlValidator":
        this.result = this.bloodBankUrlValidator.test(input);
        break;
      default:
        this.result = false;
    }
