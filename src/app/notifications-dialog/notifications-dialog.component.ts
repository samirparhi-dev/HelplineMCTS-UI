...
sDate:Date=new Date();
  ...
  valid_file_extensions = ['msg', 'pdf', 'png', 'jpeg','jpg', 'doc', 'docx', 'xlsx', 'xls', 'csv', 'txt', 'ppt'];
  ...
  constructor(private notificationService: NotificationService, public commonDataService: dataService, public dialog: MdDialog,
    private httpServiceService: HttpServices,
     @Inject(MD_DIALOG_DATA) public data: any, public dialogRef: MdDialogRef<NotificationsDialogComponent>) { }
  ...
  onFileUpload(event) {
    ...
    if (this.fileList.length == 0) {
      ...
      console.log(this.fileList[0].size / 1024 / 1024);
      this.error1 = false;
      this.error2 = false;
      this.error3 = false;
    }
